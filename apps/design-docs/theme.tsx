import { Button, Divider, Input, cn } from "@meetxl/ui";
    ...
    <>
      ...
      >
        {isMobile && (
          <div>
            <header
              className="flex flex-col border-b-[0.025rem] border-neutral-stroke px-6 pt-3 md:px-3"
              ref={ref}
            >
        ...
        {!isMobile && (
          <div className="flex h-screen flex-col gap-4 border-r-[0.025rem] border-neutral-stroke">
            <header ref={headerRef} className="flex flex-col gap-2">
              ...
              <div className="px-4 ">
                <Input
                  size="sm"
                  leftElement={<Search size="1rem" />}
                  placeholder="Search Docs"
                />
              </div>
            </header>
            <div
              className="scrollbar-none hover:scrollbar-thin scrollbar-thumb-neutral-secondary flex h-[calc(100vh-var(--header-height))] w-full flex-col gap-2 overflow-auto px-3 pb-4 transition-all"
              style={{
                ["--header-height" as string]: `${headerBounds.height}px`,
              }}
            >
              {folderChildren.map((item: MdxFile) => (
                <Link
                  ...
                  className={cn(
                    ...
                    "w-full rounded-md px-3 py-1 text-neutral-300 transition-all hover:bg-[#222326]"
                  )}
                >
